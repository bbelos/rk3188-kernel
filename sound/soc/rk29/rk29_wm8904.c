/*
 * rk29_WM8904.c  --  SoC audio for rockchip
 *
 * Driver for rockchip WM8904 audio
 *
	...
	struct snd_pcm_hw_params *params)
{
	...
	struct snd_soc_dai *cpu_dai = rtd->cpu_dai;
       ...
       // snd_soc_dai_set_clkdiv(codec_dai, WM8904_LRCLK_MODE, 0x000);
        ...
        #if defined (CONFIG_SND_RK29_CODEC_SOC_MASTER) 
        snd_soc_dai_set_clkdiv(codec_dai, WM8904_BCLK_DIV, WM8904_BCLK_DIV_4);        
        snd_soc_dai_set_clkdiv(codec_dai, WM8904_DAC_LRCLK,(pll_out/4)/params_rate(params));
        snd_soc_dai_set_clkdiv(codec_dai, WM8904_ADC_LRCLK,(pll_out/4)/params_rate(params));
        #endif
...
/*
 * Logic for a WM8904 as connected on a rockchip board.
 */
#if (LINUX_VERSION_CODE >= KERNEL_VERSION(2, 6, 37))
static int rk29_WM8904_init(struct snd_soc_pcm_runtime *rtd)
{
...
#else
static int rk29_WM8904_init(struct snd_soc_codec *codec)
{
        DBG("Enter::%s----%d\n",__FUNCTION__,__LINE__);
...
static struct snd_soc_dai_link rk29_dai = {
	...
	.codec_name = "wm8904-codec.4-001a",
	.platform_name = "rockchip-audio",
	.cpu_dai_name = "rk29_i2s.1",
	.codec_dai_name = "wm8904-hifi",
	.init = rk29_WM8904_init,
	.ops = &rk29_ops,
};
#else
static struct snd_soc_dai_link rk29_dai = {
...
static struct snd_soc_card rk29_snd_devdata = {
	  ...
	  .codec_dev = &soc_codec_dev_WM8904,
};
#endif
