	...
	IN UINT8					BW)
{
	...
	bss = cfg80211_inform_bss_frame(pCfg80211_CB->pCfg80211_Wdev->wiphy,
									&pBand->channels[IdChan],
									mgmt,
									FrameLen,
									RSSI,
									GFP_ATOMIC);
	...
	cfg80211_put_bss(pCfg80211_CB->pCfg80211_Wdev->wiphy, bss);
#else	
