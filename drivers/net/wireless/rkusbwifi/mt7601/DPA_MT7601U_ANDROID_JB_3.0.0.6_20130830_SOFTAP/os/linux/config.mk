...
# Support DYNAMIC_PD_SUPPORT
HAS_DYNAMIC_PD_SUPPORT=y

# Support Anti-noise PD(for Miracast only)
HAS_ANTI_NOISE_PD_SUPPORT=n

#support p2p force GO as sosftap
HAS_CONFIG_P2P_AUTO_GO_AS_SOFTAP=y
# Support XLINK mode
HAS_XLINK=n
...
HAS_CE_BBP_NOISE_ENDURANCE_SUPPORT=y
...
#According to Allwinner platform USB behavior need to turn on this. But this will impact the Tx performance.
#Support PBF_MONITOR_SUPPORT
HAS_PBF_MONITOR_SUPPORT=n
...
#For 7601 CE nosie endurance
ifeq ($(HAS_CE_BBP_NOISE_ENDURANCE_SUPPORT),y)
WFLAGS += -DCE_BBP_NOISE_ENDURANCE_SUPPORT
endif
...
ifeq ($(HAS_DYNAMIC_PD_SUPPORT),y)
WFLAGS += -DDYNAMIC_PD_SUPPORT
endif
...
ifeq ($(HAS_ANTI_NOISE_PD_SUPPORT),y)
WFLAGS += -DANTI_NOISE_PD_SUPPORT
endif

ifeq ($(HAS_CONFIG_P2P_AUTO_GO_AS_SOFTAP),y)
WFLAGS += -DCONFIG_P2P_AUTO_GO_AS_SOFTAP
endif
...
EXTRA_CFLAGS := $(WFLAGS) -O2  -Wno-unused-variable -Wno-unused-value -Wno-unused-label -Wno-unused-parameter -Wno-uninitialized -Wno-unused -Wno-unused-function  -I$(LINUX_SRC)/include -I$(RT28xx_DIR)/include -I$(src)/include -DCONFIG_LITTLE_ENDIAN -DALLWINNER -DPBF_MONITOR_SUPPORT
export EXTRA_CFLAGS
endif
