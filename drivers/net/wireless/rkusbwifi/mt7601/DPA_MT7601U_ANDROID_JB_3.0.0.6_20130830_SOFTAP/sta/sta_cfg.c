...
/*AP & STA mode*/
  {"FccaThr1",        Set_FalseCCA_THR1_Proc},
  {"FccaThr2",        Set_FalseCCA_THR2_Proc},  
/*AP & STA mode*/
  {"RssiThr1",        Set_RSSI_THR1_Proc},
  {"RssiThr2",        Set_RSSI_THR2_Proc},
  {"RssiThr3",        Set_RSSI_THR3_Proc},
/*P2P mode*/
  {"NoiseRssiThr1",     Set_RSSI_NOISE_THR1_Proc},
  {"NoiseRssiThr2",     Set_RSSI_NOISE_THR2_Proc},
  {"NoiseRssiThr3",     Set_RSSI_NOISE_THR3_Proc},
/*AP & STA & P2P mode*/
  {"DynaPDEn",        Set_Dynamic_PD_Enable_Proc},
...
//yiwei cfg
			...
			DBGPRINT(RT_DEBUG_TRACE, ("CFG80211_MLME !!! MLME busy, reset MLME state machine !!! ORI ==> %d\n", pAd->Mlme.CntlMachine.CurrState));
...
{
	RTMP_STA_IoctlHandle(pAdapter, NULL, CMD_RTPRIV_IOCTL_STA_SIOCSIWENCODEEXT, 0,
							  pRequest, 0, INT_MAIN);
...
*/
#if 1  //JCB0820 Sync from RT5572STA-V2.6.0.0-Release-FullCode (2)
...
#if 1  //JCB0820 Sync from RT5572STA-V2.6.0.0-Release-FullCode 
	if (!bGTK)
	{
/*
	Fix Apple TSN security (RSN (AES or TKIP unicast cipher) with WEP104 group cipher)
