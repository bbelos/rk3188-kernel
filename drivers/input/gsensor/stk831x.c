...
#if defined(CONFIG_TCHIP_MACH_TR1088) || defined(CONFIG_TCHIP_MACH_TR7088) || defined(CONFIG_TCHIP_MACH_TR7078)
...
static int stk_permission_thread(void *data)
{
	...
	do{
		...
		ret = sys_fchmodat(AT_FDCWD, "/sys/class/input/input2/driver/cali" , 0664);
