...
#include "rockchip_gslX680_tr785.h"
#elif defined(CONFIG_TCHIP_MACH_TR102Q)
#include "rockchip_gslX680_tr102q.h"
#elif defined(CONFIG_TCHIP_MACH_TR101Q)
#include "rockchip_gslX680_tr101q.h"
#elif defined(CONFIG_TCHIP_MACH_BACK_MUSIC)
...
*/
	...
	if(init_chip_flag)
	{
        ...
        if(!is_noid_version)
			{
                printk("3680A need to be reboot \n");
