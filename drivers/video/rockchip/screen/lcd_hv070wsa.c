...
#define LCD_WIDTH          	154//216
#define LCD_HEIGHT         	90//135


#define DCLK_MD	          	54000000
#define LCDC_ACLK_MD         	500000000           //29 lcdc axi DMA ÆµÂÊ
/* Timing */
#define H_PW_MD			30//10
#define H_BP_MD			60//100
#define H_VD_MD			1024//1280
#define H_FP_MD			36//18

#define V_PW_MD			10//2
#define V_BP_MD			10//8
#define V_VD_MD			600//800
#define V_FP_MD			11//6
